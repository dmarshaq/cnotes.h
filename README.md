...
`cnotes.h` end goal is to provide integration with major C compilers like, `GCC`, `Clang` and `MSVC` as well as be able to understand their various syntactical features and details. As well as be compatible with `C99` standard.
