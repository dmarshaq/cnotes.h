...
#define CN_UNPACK(str)                  (str).length, (str).data
#define CN_UNPACK_LITERAL(literal)      (sizeof(literal) - 1), (literal)
...
CNDEF void cn_lexer_print_snippet(CN_Lexer *lexer, uint64_t index, int64_t length) {
    ...
    fprintf(stderr, "\n%4d | %.*s", lexer->line_num, CN_UNPACK(cn_str_substring(line, 0, underline_offset)));
